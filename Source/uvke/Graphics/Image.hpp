...
namespace uvke {
    ...
    public:
        Image(Base* base = nullptr, const vec2i& size = { 0, 0 }, VkFormat format = VK_FORMAT_R8G8B8A8_SRGB, VkImageUsageFlags usage = VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT);
        virtual ~Image();

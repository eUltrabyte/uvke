...
namespace uvke {
    UniformBuffer::UniformBuffer(VkPhysicalDevice physicalDevice, VkDevice device, VkImageView imageView, VkSampler sampler, VkDescriptorSetLayout descriptorSetLayout)
